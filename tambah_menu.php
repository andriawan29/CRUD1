...
<html lang="en">
 ...
 <!-- Form Registrasi -->
  <div class="container">
    <h3 class="text-center mt-3 mb-5">SILAHKAN TAMBAH BUKU</h3>
    <div class="card p-5 mb-5">
      <form method="POST" action="" enctype="multipart/form-data">
        <div class="form-group">
          <label for="menu1">Nama Buku</label>
          <input type="text" class="form-control" id="menu1" name="nama_buku">
        </div>
        <div class="form-group">
          <label for="#">Jenis Buku</label>
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" value="Buku Pelajaran" name="jenis_buku" checked>Buku Pelajaran 
            </label>
          </div>
          <div class="form-check">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" value="Buku Bacaan" name="jenis_buku">Buku Bacaan
            </label>
          </div>
         </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label for="harga1">Harga Buku</label>
